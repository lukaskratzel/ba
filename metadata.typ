...
#let author = "Lukas Kratzel"
#let birthdate = datetime(day: 14, month: 03, year: 2004) // only necessary for registration certificate
#let startDate = datetime(day: 06, month: 11, year: 2025)
#let submissionDate = datetime(day: 06, month: 04, year: 2026)
#let presentationDate = datetime(day: 1, month: 5, year: 2026)
