...
#let registrationCertificate(
  ...
  align(left, text(
    ...
    1.3em,
    weight: "bold",
    "Bestätigung zur Anmeldung der " + degree + "arbeit",
  ))
  ...
  grid(
    ...
    formField(
      "Geburtsdatum",
      birthdate.display("[day].[month].[year]"),
      length: 90%,
    ),
  ...
  (
    "Hiermit bestätigen wir, dass der Kandidat/die Kandidatin sich am "
      + startDate.display("[day].[month].[year]")
      + " zur "
      + degree
  ...
  grid(
    ...
    formField(
      "Datum",
      currentDate.display("[day].[month].[year]"),
      length: 90%,
    ),
